  ...
  return (
    <div className="min-h-screen bg-[#f5f1e8] py-8 px-4 font-sans text-gray-900">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <ArrowLeft size={16} />
          {language === 'zh' ? 'ËøîÂ?' : 'Back'}
        </button>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">

          {/* Â∑¶ÂÅ¥ÔºöÁ∑®?ü„ÄÅÊ?È°å„ÄÅÂ??¢Â? */}
          ...
          {/* ?≥ÂÅ¥ÔºöÊ??ï„ÄÅÊ?Á±§„ÄÅÊí≠?æÊ??Æ„ÄÅÁ∞°‰ª?*/}
          <div className="md:col-span-2 space-y-4 pt-14">
            ...
            <div className="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3 mb-8">
              ...
              >
                <Play size={18} />
                <span>{language === 'zh' ? '?≠Êîæ' : 'Play'}</span>
              </a>
              {book.english_url && (
                <a
                ...
                >
                  <Globe size={18} />
                  <span>{language === 'zh' ? '?±Ê??? : 'English'}</span>
                </a>
              )}
            </div>
            ...
            <div className="bg-[#ede7dd] rounded-xl p-5 mt-4">
              <h3 className="text-xs text-gray-500 mb-1">
                {language === 'zh' ? '?≠ÊîæÊ∏ÖÂñÆ' : 'Playlist'}
              </h3>
            ...
            <div className="bg-[#f0ebe0] rounded-xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-500 shrink-0 w-12">{language === 'zh' ? '‰∏≠Ê??? : 'Chinese'}</span>
                ...
                {book.english_url && (
                  <>
                    ...
                    <div className="flex items-center gap-2">
                      <Globe size={14} className="text-gray-500 shrink-0" />
                      <span className="text-xs text-gray-500 shrink-0 w-12">{language === 'zh' ? '?±Ê??? : 'English'}</span>
