                ...
                <div style={{ background: '#f5f0e8', minHeight: '100vh' }}>
                        ...
                        <div style={{
                                ...
                                <h1 style={{ margin: 0, fontSize: '18px', fontWeight: '700', display: 'flex', alignItems: 'center', gap: '8px', color: '#2d2a24' }}>
                                        <Users size={20} color="#0097a7" /> ‰ΩúËÄÖÂ??Ä
                                </h1>
                                        ...
                                        <>
                                                ...
                                                <div style={{
                                                        ...
                                                        <div style={{
                                                                ...
                                                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                                                                        ...
                                                                        <span style={{ fontSize: '12px', fontWeight: '600', opacity: 0.85, textTransform: 'uppercase' }}>‰ΩúËÄÖÁ∏Ω??/span>
                                                                </div>
                                                        ...
                                                        <div style={{
                                                                ...
                                                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                                                                        ...
                                                                        <span style={{ fontSize: '12px', fontWeight: '600', color: '#6b6459', textTransform: 'uppercase' }}>?∂È??∏Á?</span>
                                                                </div>
                                                        ...
                                                        <div style={{
                                                                ...
                                                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                                                                        ...
                                                                        <span style={{ fontSize: '12px', fontWeight: '600', color: '#6b6459', textTransform: 'uppercase' }}>Ë©≥Á¥∞Á∞°‰?</span>
                                                                </div>
                                                ...
                                                <div style={{
                                                        ...
                                                        <div style={{ display: 'flex', gap: '8px' }}>
                                                                {[{ key: 'books', label: '?∏Á??∏È?' }, { key: 'name', label: '?çÁ®±?íÂ?' }].map(btn => (
